...
TEST_F(RouterStateTest, WorkspaceSaveSealsForNewMembersOnly)
{
    ...
    ASSERT_EQ(state_.buildWorkspace(workspace, &out), proto::router::kErrorOk);
...
TEST_F(RouterStateTest, WorkspaceSaveWithoutItsKeyIsRefused)
{
    ...
    proto::router::Workspace out;
    EXPECT_EQ(state_.buildWorkspace(workspace, &out), proto::router::kErrorInternalError);
}
...
TEST_F(RouterStateTest, NewWorkspaceGetsAFreshKeyThatIsNotKept)
{
    ...
    ASSERT_EQ(state_.buildWorkspace(workspace, &first), proto::router::kErrorOk);
    EXPECT_FALSE(state_.hasWorkspaceKey(0));

    proto::router::Workspace second;
    ASSERT_EQ(state_.buildWorkspace(workspace, &second), proto::router::kErrorOk);
...
TEST_F(RouterStateTest, HostAndGroupSavesRequireTheWorkspaceKey)
{
    ...
    EXPECT_EQ(state_.buildHost(host, &host_out), proto::router::kErrorInternalError);

    host.workspace_id = 10;
    ASSERT_EQ(state_.buildHost(host, &host_out), proto::router::kErrorOk);
    ...
    EXPECT_EQ(state_.buildGroup(20, group, &group_out), proto::router::kErrorInternalError);
    EXPECT_EQ(state_.buildGroup(10, group, &group_out), proto::router::kErrorOk);
}
...
TEST_F(RouterStateTest, OversizedFieldsAreRefusedBeforeTheRequestIsSent)
{
    loadKeys({10});
    ...
    EXPECT_EQ(state_.buildHost(host, &host_out), proto::router::kErrorInvalidData);
    ...
    proto::router::Group group_out;
    EXPECT_EQ(state_.buildGroup(10, group, &group_out), proto::router::kErrorInvalidData);
    ...
    EXPECT_EQ(state_.buildWorkspace(workspace, &workspace_out), proto::router::kErrorInvalidData);
...
TEST_F(RouterStateTest, AnEmptyNameIsRefusedAndTrailingBlanksAreNot)
{
    loadKeys({10});
    ...
    ASSERT_EQ(state_.buildGroup(10, group, &group_out), proto::router::kErrorOk);
    ...
    workspace.name = "  alpha  ";
    ASSERT_EQ(state_.buildWorkspace(workspace, &workspace_out), proto::router::kErrorOk);
...
TEST_F(RouterStateTest, AnEmptyHostIsSent)
{
    loadKeys({10});
    ...
    proto::router::Host host_out;
    EXPECT_EQ(state_.buildHost(host, &host_out), proto::router::kErrorOk);
}

//--------------------------------------------------------------------------------------------------
// A record sitting exactly on the bounds goes out.
TEST_F(RouterStateTest, FieldsAtTheBoundsAreSent)
{
    loadKeys({10});
    ...
    proto::router::Workspace workspace_out;
    EXPECT_EQ(state_.buildWorkspace(workspace, &workspace_out), proto::router::kErrorOk);
}
