...
#ifndef ASPIA_CLIENT__CLIENT_SESSION_DESKTOP_MANAGE_H
#define ASPIA_CLIENT__CLIENT_SESSION_DESKTOP_MANAGE_H
...
#endif // ASPIA_CLIENT__CLIENT_SESSION_DESKTOP_MANAGE_H
