...
#ifndef CLIENT_UI_SYS_INFO_OPEN_FILES_H
#define CLIENT_UI_SYS_INFO_OPEN_FILES_H
...
class SysInfoWidgetOpenFiles : public SysInfoWidget
{
    Q_OBJECT

public:
    explicit SysInfoWidgetOpenFiles(QWidget* parent = nullptr);
    ~SysInfoWidgetOpenFiles() override;
...
#endif // CLIENT_UI_SYS_INFO_OPEN_FILES_H
