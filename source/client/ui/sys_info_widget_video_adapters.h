...
#ifndef CLIENT__UI__SYS_INFO_VIDEO_ADAPTERS_H
#define CLIENT__UI__SYS_INFO_VIDEO_ADAPTERS_H
...
class SysInfoWidgetVideoAdapters : public SysInfoWidget
{
    Q_OBJECT
...
#endif // CLIENT__UI__SYS_INFO_VIDEO_ADAPTERS_H
