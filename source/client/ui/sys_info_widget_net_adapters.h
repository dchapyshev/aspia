...
#ifndef CLIENT__UI__SYS_INFO_NET_ADAPTERS_H
#define CLIENT__UI__SYS_INFO_NET_ADAPTERS_H
...
class SysInfoWidgetNetAdapters : public SysInfoWidget
{
    Q_OBJECT
...
#endif // CLIENT__UI__SYS_INFO_NET_ADAPTERS_H
