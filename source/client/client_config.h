...
public:
    ...
    const proto::desktop::Config& desktop_session_config() const;
    proto::desktop::Config* mutable_desktop_session_config();
...
private:
    ...
    proto::desktop::Config desktop_session_config_;
};
