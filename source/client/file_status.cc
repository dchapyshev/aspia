...
QString fileStatusToString(proto::FileReply::Status status)
{
    switch (status)
    {
        case proto::FileReply::STATUS_SUCCESS:
            return QCoreApplication::tr("Successfully completed", "FileStatus");

        case proto::FileReply::STATUS_INVALID_REQUEST:
            return QCoreApplication::tr("Invalid request", "FileStatus");

        case proto::FileReply::STATUS_INVALID_PATH_NAME:
        ...
        case proto::FileReply::STATUS_PATH_ALREADY_EXISTS:
            return QCoreApplication::tr("Path already exists", "FileStatus");

        case proto::FileReply::STATUS_NO_DRIVES_FOUND:
            return QCoreApplication::tr("No drives found", "FileStatus");

        case proto::FileReply::STATUS_DISK_FULL:
