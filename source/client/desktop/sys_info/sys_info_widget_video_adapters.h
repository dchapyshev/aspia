...
#ifndef CLIENT_DESKTOP_SYS_INFO_SYS_INFO_VIDEO_ADAPTERS_H
#define CLIENT_DESKTOP_SYS_INFO_SYS_INFO_VIDEO_ADAPTERS_H
...
private:
    std::unique_ptr<Ui::SysInfoVideoAdapters> ui;
};

#endif // CLIENT_DESKTOP_SYS_INFO_SYS_INFO_VIDEO_ADAPTERS_H
