...
#ifndef CLIENT_DESKTOP_SYS_INFO_SYS_INFO_NET_SHARES_H
#define CLIENT_DESKTOP_SYS_INFO_SYS_INFO_NET_SHARES_H
...
private:
    std::unique_ptr<Ui::SysInfoNetShares> ui;
};

#endif // CLIENT_DESKTOP_SYS_INFO_SYS_INFO_NET_SHARES_H
