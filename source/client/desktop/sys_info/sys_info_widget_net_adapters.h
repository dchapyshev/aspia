...
#ifndef CLIENT_DESKTOP_SYS_INFO_SYS_INFO_NET_ADAPTERS_H
#define CLIENT_DESKTOP_SYS_INFO_SYS_INFO_NET_ADAPTERS_H
...
public:
    ...
    ~SysInfoWidgetNetAdapters() final;
...
private:
    std::unique_ptr<Ui::SysInfoNetAdapters> ui;
};

#endif // CLIENT_DESKTOP_SYS_INFO_SYS_INFO_NET_ADAPTERS_H
