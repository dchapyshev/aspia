...
#ifndef CLIENT_DESKTOP_SYS_INFO_SYS_INFO_LOCAL_USERS_H
#define CLIENT_DESKTOP_SYS_INFO_SYS_INFO_LOCAL_USERS_H
...
public:
    explicit SysInfoWidgetLocalUsers(QWidget* parent = nullptr);
    ~SysInfoWidgetLocalUsers() final;
...
#endif // CLIENT_DESKTOP_SYS_INFO_SYS_INFO_LOCAL_USERS_H
