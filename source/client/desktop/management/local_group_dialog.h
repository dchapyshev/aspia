...
#ifndef CLIENT_DESKTOP_MANAGEMENT_LOCAL_GROUP_DIALOG_H
#define CLIENT_DESKTOP_MANAGEMENT_LOCAL_GROUP_DIALOG_H
...
#endif // CLIENT_DESKTOP_MANAGEMENT_LOCAL_GROUP_DIALOG_H
