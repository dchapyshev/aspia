...
#ifndef CLIENT_DESKTOP_MANAGEMENT_LOCAL_GROUP_WIDGET_H
#define CLIENT_DESKTOP_MANAGEMENT_LOCAL_GROUP_WIDGET_H
...
#endif // CLIENT_DESKTOP_MANAGEMENT_LOCAL_GROUP_WIDGET_H
