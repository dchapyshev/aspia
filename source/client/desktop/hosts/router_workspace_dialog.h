...
#ifndef CLIENT_DESKTOP_HOSTS_ROUTER_WORKSPACE_DIALOG_H
#define CLIENT_DESKTOP_HOSTS_ROUTER_WORKSPACE_DIALOG_H
...
#endif // CLIENT_DESKTOP_HOSTS_ROUTER_WORKSPACE_DIALOG_H
