...
quint8 diffFullBlock_32x2_SSE3(const quint8* image1, const quint8* image2, int bytes_per_row)
{
    ...
    i1 = reinterpret_cast<const __m128i*>(image1);
    i2 = reinterpret_cast<const __m128i*>(image2);
    ...
    i1 = reinterpret_cast<const __m128i*>(image1 + bytes_per_row);
    i2 = reinterpret_cast<const __m128i*>(image2 + bytes_per_row);
