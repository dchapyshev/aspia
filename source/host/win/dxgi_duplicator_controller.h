...
#ifndef HOST_WIN_DXGI_DUPLICATOR_CONTROLLER_H
#define HOST_WIN_DXGI_DUPLICATOR_CONTROLLER_H

#include "host/win/dxgi_adapter_duplicator.h"
...
#endif // HOST_WIN_DXGI_DUPLICATOR_CONTROLLER_H
