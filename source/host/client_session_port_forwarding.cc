...
//--------------------------------------------------------------------------------------------------
void ClientSessionPortForwarding::onReceived(uint8_t /* channel_id */, const base::ByteArray& buffer)
{
...
//--------------------------------------------------------------------------------------------------
void ClientSessionPortForwarding::onWritten(uint8_t /* channel_id */, size_t /* pending */)
{
    // Nothing
}
