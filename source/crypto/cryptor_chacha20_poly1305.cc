...
CryptorChaCha20Poly1305::~CryptorChaCha20Poly1305()
{
...
// static
std::unique_ptr<Cryptor> CryptorChaCha20Poly1305::create(
    base::ByteArray&& key, base::ByteArray&& encrypt_iv, base::ByteArray&& decrypt_iv)
{
    ...
    return std::unique_ptr<Cryptor>(
        new CryptorChaCha20Poly1305(std::move(encrypt_ctx), std::move(decrypt_ctx),
...
bool CryptorChaCha20Poly1305::encrypt(const uint8_t* in, size_t in_size, uint8_t* out)
{
...
bool CryptorChaCha20Poly1305::decrypt(const uint8_t* in, size_t in_size, uint8_t* out)
{
