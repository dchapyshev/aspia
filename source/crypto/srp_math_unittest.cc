...
TEST(srp_math_test, test_vector)
{
    ...
    const uint8_t x_ref_buf[] = { 0x94, 0xB7, 0x55, 0x5A, 0xAB, 0xE9, 0x12, 0x7C, 0xC5, 0x8C, 0xCF,
                                  0x49, 0x93, 0xDB, 0x6C, 0xF8, 0x4D, 0x16, 0xC1, 0x24 };

    const uint8_t u_ref_buf[] = { 0xCE, 0x38, 0xB9, 0x59, 0x34, 0x87, 0xDA, 0x98, 0x55, 0x4E, 0xD4,
                                  0x7D, 0x70, 0xA7, 0xAE, 0x5F, 0x46, 0x2E, 0xF0, 0x19 };

    const uint8_t v_ref_buf[] =
    {
        0x7E, 0x27, 0x3D, 0xE8, 0x69, 0x6F, 0xFC, 0x4F, 0x4E, 0x33, 0x7D, 0x05, 0xB4, 0xB3, 0x75,
        0xBE, 0xB0, 0xDD, 0xE1, 0x56, 0x9E, 0x8F, 0xA0, 0x0A, 0x98, 0x86, 0xD8, 0x12, 0x9B, 0xAD,
        0xA1, 0xF1, 0x82, 0x22, 0x23, 0xCA, 0x1A, 0x60, 0x5B, 0x53, 0x0E, 0x37, 0x9B, 0xA4, 0x72,
        0x9F, 0xDC, 0x59, 0xF1, 0x05, 0xB4, 0x78, 0x7E, 0x51, 0x86, 0xF5, 0xC6, 0x71, 0x08, 0x5A,
        0x14, 0x47, 0xB5, 0x2A, 0x48, 0xCF, 0x19, 0x70, 0xB4, 0xFB, 0x6F, 0x84, 0x00, 0xBB, 0xF4,
        0xCE, 0xBF, 0xBB, 0x16, 0x81, 0x52, 0xE0, 0x8A, 0xB5, 0xEA, 0x53, 0xD1, 0x5C, 0x1A, 0xFF,
        0x87, 0xB2, 0xB9, 0xDA, 0x6E, 0x04, 0xE0, 0x58, 0xAD, 0x51, 0xCC, 0x72, 0xBF, 0xC9, 0x03,
        0x3B, 0x56, 0x4E, 0x26, 0x48, 0x0D, 0x78, 0xE9, 0x55, 0xA5, 0xE2, 0x9E, 0x7A, 0xB2, 0x45,
    ...
    {
        
    };

    const uint8_t key_ref_buf[] =
    {
        
    };

    static_assert(sizeof(a_buf) == 32);
    static_assert(sizeof(b_buf) == 32);
    static_assert(sizeof(s_buf) == 16);
    static_assert(sizeof(x_ref_buf) == 20);
    static_assert(sizeof(u_ref_buf) == 20);
