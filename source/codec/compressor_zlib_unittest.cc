...
{
    CompressorZLIB compressor(compress_ratio);
...
TEST(compressor_zlib_test, compress_decompress)
{
    ...
    ImageBuffer compressed_buffer = compress(6, source_buffer);
...
TEST(compressor_zlib_test, DISABLED_benchmark)
{
    ...
    {
        // Image 1.
        ImageBuffer compressed_buffer1 = compress(6, source_buffer1);
        ...
        // Image 2.
        ImageBuffer compressed_buffer2 = compress(6, source_buffer2);
