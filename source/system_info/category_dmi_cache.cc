//
// PROJECT:         Aspia
// FILE:            system_info/category_dmi_cache.cc
...
#include "system_info/category_dmi_cache.pb.h"
...
std::string CategoryDmiCache::Serialize()
{
    ...
    for (SMBios::TableEnumeratorNew table_enumerator(*smbios, SMBios::TABLE_TYPE_CACHE);
