//
// PROJECT:         Aspia
// FILE:            system_info/category_dmi_processor.cc
...
#include "system_info/category_dmi_processor.pb.h"
...
const char* FamilyToString(proto::DmiProcessors::Family value)
{
    switch (value)
    {
...
const char* TypeToString(proto::DmiProcessors::Type value)
{
    switch (value)
    {
...
const char* StatusToString(proto::DmiProcessors::Status value)
{
    switch (value)
    {
...
const char* UpgradeToString(proto::DmiProcessors::Upgrade value)
{
    switch (value)
    {
...
proto::DmiProcessors::Family GetFamily(const SMBios::TableReader& table)
{
...
proto::DmiProcessors::Type GetType(uint8_t value)
{
    switch (value)
    {
...
proto::DmiProcessors::Status GetStatus(uint8_t value)
{
...
proto::DmiProcessors::Upgrade GetUpgrade(uint8_t value)
{
    switch (value)
    {
