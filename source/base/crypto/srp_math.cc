...
static_assert(sizeof(kGroup_1024) == 1024 / 8);
static_assert(sizeof(kGroup_1536) == 1536 / 8);
static_assert(sizeof(kGroup_2048) == 2048 / 8);
static_assert(sizeof(kGroup_3072) == 3072 / 8);
static_assert(sizeof(kGroup_4096) == 4096 / 8);
static_assert(sizeof(kGroup_6144) == 6144 / 8);
static_assert(sizeof(kGroup_8192) == 8192 / 8);

const quint8 kGenerator_2[] = { 2 };
const quint8 kGenerator_5[] = { 5 };
const quint8 kGenerator_19[] = { 19 };
...
//--------------------------------------------------------------------------------------------------
const SrpMath::NgPair SrpMath::kNgPair_1024 =
{
    { reinterpret_cast<const char*>(kGroup_1024), sizeof(kGroup_1024) },
    { reinterpret_cast<const char*>(kGenerator_2), sizeof(kGenerator_2) }
};

//--------------------------------------------------------------------------------------------------
const SrpMath::NgPair SrpMath::kNgPair_1536 =
{
    { reinterpret_cast<const char*>(kGroup_1536), sizeof(kGroup_1536) },
    { reinterpret_cast<const char*>(kGenerator_2), sizeof(kGenerator_2) }
};

//--------------------------------------------------------------------------------------------------
const SrpMath::NgPair SrpMath::kNgPair_2048 =
{
    { reinterpret_cast<const char*>(kGroup_2048), sizeof(kGroup_2048) },
    { reinterpret_cast<const char*>(kGenerator_2), sizeof(kGenerator_2) }
};

//--------------------------------------------------------------------------------------------------
const SrpMath::NgPair SrpMath::kNgPair_3072 =
{
    { reinterpret_cast<const char*>(kGroup_3072), sizeof(kGroup_3072) },
    { reinterpret_cast<const char*>(kGenerator_5), sizeof(kGenerator_5) }
};

//--------------------------------------------------------------------------------------------------
const SrpMath::NgPair SrpMath::kNgPair_4096 =
{
    { reinterpret_cast<const char*>(kGroup_4096), sizeof(kGroup_4096) },
    { reinterpret_cast<const char*>(kGenerator_5), sizeof(kGenerator_5) }
};

//--------------------------------------------------------------------------------------------------
const SrpMath::NgPair SrpMath::kNgPair_6144 =
{
    { reinterpret_cast<const char*>(kGroup_6144), sizeof(kGroup_6144) },
    { reinterpret_cast<const char*>(kGenerator_5), sizeof(kGenerator_5) }
};

//--------------------------------------------------------------------------------------------------
const SrpMath::NgPair SrpMath::kNgPair_8192 =
{
    { reinterpret_cast<const char*>(kGroup_8192), sizeof(kGroup_8192) },
    { reinterpret_cast<const char*>(kGenerator_19), sizeof(kGenerator_19) }
};
...
std::optional<SrpMath::NgPair> SrpMath::pairByGroup(const QString& group)
{
    if (group == QLatin1String("8192"))
        return SrpMath::kNgPair_8192;
    else if (group == QLatin1String("6144"))
        return SrpMath::kNgPair_6144;
    else if (group == QLatin1String("4096"))
        return SrpMath::kNgPair_4096;
    else if (group == QLatin1String("3072"))
        return SrpMath::kNgPair_3072;
    else if (group == QLatin1String("2048"))
        return SrpMath::kNgPair_2048;
    else if (group == QLatin1String("1536"))
        return SrpMath::kNgPair_1536;
    else if (group == QLatin1String("1024"))
        return SrpMath::kNgPair_1024;
    else
        return std::nullopt;
}
