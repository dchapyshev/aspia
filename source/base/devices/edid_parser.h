...
public:
    ...
    int GetEdidVersion() const;
    int GetEdidRevision() const;
    int GetMaxHorizontalImageSize() const; // in cm.
    int GetMaxVerticalImageSize() const; // in cm.
    int GetHorizontalResolution() const;
    int GetVerticalResolution() const;
    double GetGamma() const;
    uint8_t GetFeatureSupport() const;
    int GetMinVerticalRate() const; // Hz
    int GetMaxVerticalRate() const; // Hz
    int GetMinHorizontalRate() const; // kHz
    int GetMaxHorizontalRate() const; // kHz
    ...
    int GetStandardTimingsCount() const;
