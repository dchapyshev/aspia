...
const uint32_t kMaxMessageSize = 7 * 1024 * 1024; // 7 MB
...
// static
std::string KcpChannel::errorToString(ErrorCode error_code)
{
    const char* str;
...
void KcpChannel::addTxBytes(size_t bytes_count)
{
    bytes_tx_ += bytes_count;
    total_tx_ += bytes_count;
}

void KcpChannel::addRxBytes(size_t bytes_count)
{
