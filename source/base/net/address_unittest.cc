...
{
    Address addr1 = Address::fromString(u"http://test.com");
    EXPECT_FALSE(addr1.isValid());
    EXPECT_TRUE(addr1.host().empty());
    EXPECT_EQ(addr1.port(), 0);

    EXPECT_FALSE(Address::fromString(u"https://test1.org").isValid());
    EXPECT_FALSE(Address::fromString(u"ftp://test2.net").isValid());
    EXPECT_FALSE(Address::fromString(u"te%st2").isValid());
    EXPECT_FALSE(Address::fromString(u"//").isValid());
    EXPECT_FALSE(Address::fromString(u"..").isValid());
    EXPECT_FALSE(Address::fromString(u".").isValid());
    EXPECT_FALSE(Address::fromString(u"\\").isValid());
    EXPECT_FALSE(Address::fromString(u"/").isValid());
    ...
    EXPECT_FALSE(Address::fromString(u"^").isValid());
    EXPECT_FALSE(Address::fromString(u"#").isValid());
    EXPECT_FALSE(Address::fromString(u"2001:db8:1f70::999:de8:7648:6e8").isValid());
}

TEST(AddressTest, ValidAddress)
{
    Address addr1 = Address::fromString(u"192.168.1.1");
    ...
    Address addr4 = Address::fromString(u"test.com:8080");
    ...
    Address addr5 = Address::fromString(u"test");
    ...
    Address addr6 = Address::fromString(u"test:8080");
    EXPECT_TRUE(addr6.isValid());
    EXPECT_EQ(addr6.host(), u"test");
    EXPECT_EQ(addr6.port(), 8080);
    EXPECT_EQ(addr6.toString(), u"test:8080");

    Address addr7 = Address::fromString(u"[2001:db8:1f70::999:de8:7648:6e8]");
    ...
    Address addr8 = Address::fromString(u"[2001:db8:1f70::999:de8:7648:6e8]:8080");
    ...
    Address addr9 = Address::fromString(u"[::ffff:192.0.2.1]");
    ...
    Address addr10 = Address::fromString(u"[::ffff:192.0.2.1]:8080");
...
TEST(AddressTest, TestVector)
{
    ...
    Address addr = Address::fromString(u"192.168.1.1:8050");
