...
#ifndef BASE_PEER_CLIENT_AUTHENTICATOR_LEGACY_H
...
public:
    explicit ClientAuthenticatorLegacy(QObject* parent = nullptr);
    ~ClientAuthenticatorLegacy() final;
...
private:
    ...
    Q_DISABLE_COPY_MOVE(ClientAuthenticatorLegacy)
};

#endif // BASE_PEER_CLIENT_AUTHENTICATOR_LEGACY_H
