...
#ifndef BASE_PEER_SERVER_AUTHENTICATOR_LEGACY_H
#define BASE_PEER_SERVER_AUTHENTICATOR_LEGACY_H
...
public:
    explicit ServerAuthenticatorLegacy(QObject* parent = nullptr);
    ~ServerAuthenticatorLegacy() final;
...
private:
    ...
    Q_DISABLE_COPY_MOVE(ServerAuthenticatorLegacy)
};

#endif // BASE_PEER_SERVER_AUTHENTICATOR_LEGACY_H
