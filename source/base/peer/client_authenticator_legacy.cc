...
ClientAuthenticatorLegacy::ClientAuthenticatorLegacy(QObject* parent)
    : Authenticator(Authenticator::Protocol::LEGACY, parent)
{
    CLOG(TRACE) << "Ctor";
}
...
//--------------------------------------------------------------------------------------------------
bool ClientAuthenticatorLegacy::onStarted()
{
    sendClientHello();
    return true;
}
...
//--------------------------------------------------------------------------------------------------
void ClientAuthenticatorLegacy::onReceived(const QByteArray& buffer)
{
...
//--------------------------------------------------------------------------------------------------
void ClientAuthenticatorLegacy::sendIdentify()
{
...
//--------------------------------------------------------------------------------------------------
void ClientAuthenticatorLegacy::sendClientKeyExchange()
{
...
//--------------------------------------------------------------------------------------------------
void ClientAuthenticatorLegacy::sendSessionResponse()
{
