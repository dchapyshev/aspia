...
#ifndef BASE__CODEC__AUDIO_SAMPLE_TYPES_H
#define BASE__CODEC__AUDIO_SAMPLE_TYPES_H
...
public:
    ...
    static SampleType FromFloat(float source_value) { return From<float>(source_value); }
    static float ToFloat(SampleType source_value) { return To<float>(source_value); }
    static SampleType FromDouble(double source_value) { return From<double>(source_value); }
    static double ToDouble(SampleType source_value) { return To<double>(source_value); }
...
#endif // BASE__CODEC__AUDIO_SAMPLE_TYPES_H
