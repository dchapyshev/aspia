...
#ifndef BASE__AUDIO__WIN__DEFAULT_AUDIO_DEVICE_CHANGE_DETECTOR_H
#define BASE__AUDIO__WIN__DEFAULT_AUDIO_DEVICE_CHANGE_DETECTOR_H
...
#endif // BASE__AUDIO__WIN__DEFAULT_AUDIO_DEVICE_CHANGE_DETECTOR_H
