...
TEST(desktop_region_test, non_overlapping_rects)
{
    ...
    {
        Rect::makeXYWH(10, 10, 10, 10),
        Rect::makeXYWH(10, 30, 10, 5)
    }
        },
        {
            3,
    {
        Rect::makeXYWH(10, 10, 10, 9),
        Rect::makeXYWH(30, 10, 15, 10),
        Rect::makeXYWH(10, 30, 8, 10)
    }
        },
        {
            4,
    {
        Rect::makeXYWH(0, 0, 30, 10),
        Rect::makeXYWH(40, 0, 10, 30),
        Rect::makeXYWH(0, 20, 10, 30),
        Rect::makeXYWH(20, 40, 30, 10)
    }
        },
        {
            4,
    {
        Rect::makeXYWH(0, 0, 10, 100),
        Rect::makeXYWH(20, 10, 30, 10),
        Rect::makeXYWH(20, 30, 30, 10),
        Rect::makeXYWH(20, 50, 30, 10)
    }
        },
    };
...
TEST(desktop_region_test, complex_regions)
{
            ...
            4,
    {
        ...
        6,
    {
        Rect::makeLTRB(0, 0, 30, 10),
        Rect::makeLTRB(50, 0, 65, 15),
        Rect::makeLTRB(0, 10, 40, 20),
        Rect::makeLTRB(0, 20, 50, 30),
        Rect::makeLTRB(10, 30, 50, 40),
        Rect::makeLTRB(20, 40, 50, 50)
    }
        },
        {
            3,
