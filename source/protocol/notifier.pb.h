...
#ifndef PROTOBUF_notifier_2eproto__INCLUDED
#define PROTOBUF_notifier_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsSession();
  InitDefaultsSessionClose();
  InitDefaultsKillSession();
  InitDefaultsNotifierToService();
  InitDefaultsServiceToNotifier();
}
}  // namespace protobuf_notifier_2eproto
namespace aspia {
namespace proto {
...
class Session : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:aspia.proto.notifier.Session) */ {
 ...
 private:
  ...
  friend void ::protobuf_notifier_2eproto::InitDefaultsSessionImpl();
};
// -------------------------------------------------------------------
...
class SessionClose : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:aspia.proto.notifier.SessionClose) */ {
 public:
  ...
  inline SessionClose* New() const PROTOBUF_FINAL { return New(NULL); }

  SessionClose* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_notifier_2eproto::TableStruct;
  friend void ::protobuf_notifier_2eproto::InitDefaultsSessionCloseImpl();
};
// -------------------------------------------------------------------
...
class KillSession : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:aspia.proto.notifier.KillSession) */ {
 public:
  ...
  inline KillSession* New() const PROTOBUF_FINAL { return New(NULL); }

  KillSession* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_notifier_2eproto::TableStruct;
  friend void ::protobuf_notifier_2eproto::InitDefaultsKillSessionImpl();
};
// -------------------------------------------------------------------
...
class NotifierToService : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:aspia.proto.notifier.NotifierToService) */ {
 public:
  ...
  inline NotifierToService* New() const PROTOBUF_FINAL { return New(NULL); }

  NotifierToService* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_notifier_2eproto::TableStruct;
  friend void ::protobuf_notifier_2eproto::InitDefaultsNotifierToServiceImpl();
};
// -------------------------------------------------------------------
...
class ServiceToNotifier : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:aspia.proto.notifier.ServiceToNotifier) */ {
 public:
  ...
  inline ServiceToNotifier* New() const PROTOBUF_FINAL { return New(NULL); }

  ServiceToNotifier* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_notifier_2eproto::TableStruct;
  friend void ::protobuf_notifier_2eproto::InitDefaultsServiceToNotifierImpl();
};
// ===================================================================
...
inline ::aspia::proto::notifier::KillSession* NotifierToService::mutable_kill_session() {
  ...
  if (kill_session_ == NULL) {
    kill_session_ = new ::aspia::proto::notifier::KillSession;
  }
...
inline ::aspia::proto::notifier::Session* ServiceToNotifier::mutable_session() {
  ...
  if (session_ == NULL) {
    session_ = new ::aspia::proto::notifier::Session;
  }
...
inline ::aspia::proto::notifier::SessionClose* ServiceToNotifier::mutable_session_close() {
  ...
  if (session_close_ == NULL) {
    session_close_ = new ::aspia::proto::notifier::SessionClose;
  }
...
#endif  // PROTOBUF_notifier_2eproto__INCLUDED
