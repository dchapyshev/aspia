...
// static
bool CategorySMART::IsMicronMU02SSD(const proto::SMART::Drive& drive)
{
...
// static
bool CategorySMART::IsSamsungSSD(const proto::SMART::Drive& drive)
{
...
// static
bool CategorySMART::IsKingstonUV400(const proto::SMART::Drive& drive)
{
    std::string model_number = ToUpperASCII(drive.model_number());
...
// static
bool CategorySMART::IsSandForceSSD(const proto::SMART::Drive& drive)
{
    if (drive.attribute_size() >= 7 &&
        drive.attribute(0).id() == 0x01 &&
        drive.attribute(1).id() == 0x05 &&
...
// static
const char* CategorySMART::AttributeToString(DriveType type, uint32_t value)
{
    switch (type)
    {
...
// static
const char* CategorySMART::GenericAttributeToString(uint32_t value)
{
    switch (value)
    {
...
// static
const char* CategorySMART::IntelAttributeToString(uint32_t value)
{
    switch (value)
    {
...
// static
const char* CategorySMART::MicronMU02AttributeToString(uint32_t value)
{
    switch (value)
    {
        case 0x01: return "Raw Read Error Rate";
...
// static
const char* CategorySMART::SamsungAttributeToString(uint32_t value)
{
    switch (value)
    {
...
// static
const char* CategorySMART::KingstonUV400AttributeToString(uint32_t value)
{
    switch (value)
    {
        case 0x01: return "Read Error Rate";
...
// static
const char* CategorySMART::SandForceAttributeToString(uint32_t value)
{
    switch (value)
    {
        case 0x01: return "Raw Read Error Rate";
...
// static
const char* CategoryLogicalDrives::DriveTypeToString(proto::LogicalDrive::DriveType value)
{
    switch (value)
    {
