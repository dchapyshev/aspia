...
std::string CategoryCPU::Serialize()
{
    ...
    message.set_brand_string(cpu_info.brand_string);
    message.set_vendor(cpu_info.vendor);
    ...
    // Function 1 EDX
    add(cpu_info.func_1_edx.has_fpu, "Floating-point Unit On-Chip (FPU)");
    add(cpu_info.func_1_edx.has_vme, "Virtual Mode Extension (VME)");
    add(cpu_info.func_1_edx.has_de, "Debug Extension (DE)");
    add(cpu_info.func_1_edx.has_pse, "Page Size Extension (PSE)");
    add(cpu_info.func_1_edx.has_tsc, "Time Stamp Extension (TSC)");
    add(cpu_info.func_1_edx.has_msr, "Model Specific Registers (MSR)");
    add(cpu_info.func_1_edx.has_pae, "Physical Address Extension (PAE)");
    add(cpu_info.func_1_edx.has_mce, "Machine-Check Exception (MCE)");
    add(cpu_info.func_1_edx.has_cx8, "CMPXCHG8 Instruction (CX8)");
    add(cpu_info.func_1_edx.has_apic, "On-cpip APIC Hardware (APIC)");
    add(cpu_info.func_1_edx.has_sep, "Fast System Call (SEP)");
    add(cpu_info.func_1_edx.has_mtrr, "Memory Type Range Registers (MTRR)");
    add(cpu_info.func_1_edx.has_pge, "Page Global Enable (PGE)");
    add(cpu_info.func_1_edx.has_mca, "Machine-Check Architecture (MCA)");
    add(cpu_info.func_1_edx.has_cmov, "Conditional Move Instruction (CMOV)");
    add(cpu_info.func_1_edx.has_pat, "Page Attribute Table (PAT)");
    add(cpu_info.func_1_edx.has_pse36, "36-bit Page Size Extension (PSE36)");
    add(cpu_info.func_1_edx.has_psn, "Processor Serial Number (PSN)");
    add(cpu_info.func_1_edx.has_clfsh, "CLFLUSH Instruction");
    add(cpu_info.func_1_edx.has_ds, "Debug Store (DS)");
    add(cpu_info.func_1_edx.has_acpu, "Thermal Monitor and Software Controlled Clock Facilities (ACPU)");
    add(cpu_info.func_1_edx.has_mmx, "MMX Technology (MMX)");
    add(cpu_info.func_1_edx.has_fxsr, "FXSAVE and FXSTOR Instructions (FXSR)");
    add(cpu_info.func_1_edx.has_sse, "Streaming SIMD Extension (SSE)");
    add(cpu_info.func_1_edx.has_sse2, "Streaming SIMD Extension 2 (SSE2)");
    add(cpu_info.func_1_edx.has_ss, "Self-Snoop (SS)");
    add(cpu_info.func_1_edx.has_htt, "Multi-Threading (HTT)");
    add(cpu_info.func_1_edx.has_tm, "Thermal Monitor (TM)");
    add(cpu_info.func_1_edx.has_pbe, "Pending Break Enable (PBE)");

    // Function 1 ECX
    add(cpu_info.func_1_ecx.has_sse3, "Streaming SIMD Extension 3 (SSE3)");
    add(cpu_info.func_1_ecx.has_pclmuldq, "PCLMULDQ Instruction");
    add(cpu_info.func_1_ecx.has_dtes64, "64-Bit Debug Store (DTES64)");
    add(cpu_info.func_1_ecx.has_monitor, "MONITOR/MWAIT Instructions");
    add(cpu_info.func_1_ecx.has_ds_cpl, "CPL Qualified Debug Store");
    add(cpu_info.func_1_ecx.has_vmx, "Virtual Machine Extensions (VMX)");
    add(cpu_info.func_1_ecx.has_smx, "Safe Mode Extensions (SMX)");
    add(cpu_info.func_1_ecx.has_est, "Enhanced SpeedStep Technology (EIST, ESS)");
    add(cpu_info.func_1_ecx.has_tm2, "Thermal Monitor 2 (TM2)");
    add(cpu_info.func_1_ecx.has_ssse3, "Supplemental Streaming SIMD Extension 3 (SSSE3)");
    add(cpu_info.func_1_ecx.has_cnxt_id, "L1 Context ID");
    add(cpu_info.func_1_ecx.has_fma, "Fused Multiply Add (FMA)");
    add(cpu_info.func_1_ecx.has_cx16, "CMPXCHG16B Instruction");
    add(cpu_info.func_1_ecx.has_xtpr, "xTPR Update Control");
    add(cpu_info.func_1_ecx.has_pdcm, "Perfmon and Debug Capability");
    add(cpu_info.func_1_ecx.has_pcid, "Process Context Identifiers");
    add(cpu_info.func_1_ecx.has_dca, "Direct Cache Access (DCA)");
    add(cpu_info.func_1_ecx.has_sse41, "Streaming SIMD Extension 4.1 (SSE4.1)");
    add(cpu_info.func_1_ecx.has_sse42, "Streaming SIMD Extension 4.2 (SSE4.2)");
    add(cpu_info.func_1_ecx.has_x2apic, "Extended xAPIC Support");
    add(cpu_info.func_1_ecx.has_movbe, "MOVBE Instruction");
    add(cpu_info.func_1_ecx.has_popcnt, "POPCNT Instruction");
    add(cpu_info.func_1_ecx.has_tsc_deadline, "Time Stamp Counter Deadline");
    add(cpu_info.func_1_ecx.has_aes, "AES Instruction (AES)");
    add(cpu_info.func_1_ecx.has_xsave, "XSAVE/XSTOR States");
    add(cpu_info.func_1_ecx.has_osxsave, "OS-Enabled Extended State Management");
    add(cpu_info.func_1_ecx.has_avx, "Advanced Vector Extension (AVX)");
    add(cpu_info.func_1_ecx.has_f16c, "Float-16-bit Convertsion Instructions (F16C)");
    add(cpu_info.func_1_ecx.has_rdrand, "RDRAND Instruction");

    // Function 0x80000001 EDX
    add(cpu_info.func_81_edx.has_syscall, "SYSCALL/SYSRET Instructions");
    add(cpu_info.func_81_edx.has_xd_bit, "Execution Disable Bit");
    add(cpu_info.func_81_edx.has_1gb_pages, "1 GB Pages");
    add(cpu_info.func_81_edx.has_rdtscp, "RDTSCP and IA32_TSC_AUX Supported");
    add(cpu_info.func_81_edx.has_intel64, "64-bit x86 Extension (AMD64, Intel64)");

    // Function 0x80000001 ECX
    add(cpu_info.func_81_ecx.has_lahf, "LAHF/SAHF Instructions");

    // Function 7 EBX
    add(cpu_info.func_7_0_ebx.has_fsgsbase, "Access to base of %fs and %gs");
    add(cpu_info.func_7_0_ebx.has_sgx, "Software Guard Extensions (SGE)");
    add(cpu_info.func_7_0_ebx.has_bmi1, "Bit Manipulation Instruction Set 1 (BMI1)");
    add(cpu_info.func_7_0_ebx.has_hle, "Transactional Synchronization Extensions");
    add(cpu_info.func_7_0_ebx.has_avx2, "Advanced Vector Extensions 2 (AVX2)");
    add(cpu_info.func_7_0_ebx.has_smep, "Supervisor-Mode Execution Prevention");
    add(cpu_info.func_7_0_ebx.has_bmi2, "Bit Manipulation Instruction Set 2 (BMI2)");
    add(cpu_info.func_7_0_ebx.has_erms, "Enhanced REP MOVSB/STOSB");
    add(cpu_info.func_7_0_ebx.has_invpcid, "INVPCID Instruction");
    add(cpu_info.func_7_0_ebx.has_rtm, "Transactional Synchronization Extensions (RTM)");
    add(cpu_info.func_7_0_ebx.has_pqm, "Platform Quality of Service Monitoring (PQM)");
    add(cpu_info.func_7_0_ebx.has_mpx, "Memory Protection Extensions (MPX)");
    add(cpu_info.func_7_0_ebx.has_pqe, "Platform Quality of Service Enforcement (PQE)");
    add(cpu_info.func_7_0_ebx.has_avx512f, "AVX-512 Foundation (AVX512F)");
    add(cpu_info.func_7_0_ebx.has_avx512dq, "AVX-512 Doubleword and Quadword Instructions (AVX512DQ)");
    add(cpu_info.func_7_0_ebx.has_rdseed, "RDSEED Instruction");
    add(cpu_info.func_7_0_ebx.has_adx, "Multi-Precision Add-Carry Instruction Extensions (ADX)");
    add(cpu_info.func_7_0_ebx.has_smap, "Supervisor Mode Access Prevention (SMAP)");
    add(cpu_info.func_7_0_ebx.has_avx512ifma, "AVX-512 Integer Fused Multiply-Add Instructions");
    add(cpu_info.func_7_0_ebx.has_pcommit, "PCOMMIT Instruction");
    add(cpu_info.func_7_0_ebx.has_clflushopt, "CLFLUSHOPT Instruction");
    add(cpu_info.func_7_0_ebx.has_clwb, "CLWB Instruction");
    add(cpu_info.func_7_0_ebx.has_intel_pt, "Intel Processor Trace");
    add(cpu_info.func_7_0_ebx.has_avx512pf, "AVX-512 Prefetch Instructions (AVX512PF)");
    add(cpu_info.func_7_0_ebx.has_avx512er, "AVX-512 Exponential and Reciprocal Instructions (AVX512ER)");
    add(cpu_info.func_7_0_ebx.has_avx512cd, "AVX-512 Conflict Detection Instructions (AVX512CD)");
    add(cpu_info.func_7_0_ebx.has_sha, "Intel SHA Extensions (SHA)");
    add(cpu_info.func_7_0_ebx.has_avx512bw, "AVX-512 Byte and Word Instructions (AVX512BW)");
    add(cpu_info.func_7_0_ebx.has_avx512vl, "AVX-512 Vector Length Extensions (AVX512VL)");

    // Function 7 ECX
    add(cpu_info.func_7_0_ecx.has_prefetchwt1, "PREFETCHWT1 Instruction");
    add(cpu_info.func_7_0_ecx.has_avx512vbmi, "AVX-512 Vector Bit Manipulation Instructions (AVX512VBMI)");
    add(cpu_info.func_7_0_ecx.has_umip, "User-mode Instruction Prevention (UMIP)");
    add(cpu_info.func_7_0_ecx.has_pku, "Memory Protection Keys for User-mode pages (PKU)");
    add(cpu_info.func_7_0_ecx.has_ospke, "PKU enabled by OS (OSPKE)");
    add(cpu_info.func_7_0_ecx.has_avx512vbmi2, "AVX-512 Vector Bit Manipulation Instructions 2 (AVX512VBMI2)");
    add(cpu_info.func_7_0_ecx.has_gfni, "Galois Field Instructions (GFNI)");
    add(cpu_info.func_7_0_ecx.has_vaes, "AES Instruction Set (VEX-256/EVEX)");
    add(cpu_info.func_7_0_ecx.has_vpclmulqdq, "CLMUL Instruction Set (VEX-256/EVEX)");
    add(cpu_info.func_7_0_ecx.has_avx512vnni, "AVX-512 Vector Neural Network Instructions (AVX512VNNI)");
    add(cpu_info.func_7_0_ecx.has_avx512bitalg, "AVX-512 BITALG Instructions (AVX512BITALG)");
    add(cpu_info.func_7_0_ecx.has_avx512vpopcntdq, "AVX-512 Vector Population Count D/Q (AVX512VPOPCNTDQ)");
    add(cpu_info.func_7_0_ecx.has_rdpid, "Read Processor ID (RDPID)");
    add(cpu_info.func_7_0_ecx.has_sgx_lc, "SGX Launch Configuration");

    // Function 7 EDX
    add(cpu_info.func_7_0_edx.has_avx512_4vnniw, "AVX-512 4-register Neural Network Instructions (AVX5124VNNIW)");
    add(cpu_info.func_7_0_edx.has_avx512_4fmaps, "AVX-512 4-register Multiply Accumulation Single precision (AVX5124FMAPS)");
