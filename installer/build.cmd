...
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-de-de.msi" -cultures:de-de -ext WixUtilExtension -ext WixUIExtension -loc translations\console.de-de.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-en-us.msi" -cultures:en-us -ext WixUtilExtension -ext WixUIExtension -loc translations\console.en-us.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-it-it.msi" -cultures:it-it -ext WixUtilExtension -ext WixUIExtension -loc translations\console.it-it.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-nl-nl.msi" -cultures:nl-nl -ext WixUtilExtension -ext WixUIExtension -loc translations\console.nl-nl.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-pt-br.msi" -cultures:pt-br -ext WixUtilExtension -ext WixUIExtension -loc translations\console.pt-br.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-ru-ru.msi" -cultures:ru-ru -ext WixUtilExtension -ext WixUIExtension -loc translations\console.ru-ru.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-uk-ua.msi" -cultures:uk-ua -ext WixUtilExtension -ext WixUIExtension -loc translations\console.uk-ua.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-zh-cn.msi" -cultures:zh-cn -ext WixUtilExtension -ext WixUIExtension -loc translations\console.zh-cn.wxl "%TMP_DIR%\console.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-console-zh-tw.msi" -cultures:zh-tw -ext WixUtilExtension -ext WixUIExtension -loc translations\console.zh-tw.wxl "%TMP_DIR%\console.wixobj"
...
copy %TMP_DIR%\aspia-console-en-us.msi %ASPIA_BIN_DIR%\aspia-console-%ASPIA_VERSION%-%ASPIA_ARCH%.msi

echo "##################################################"
echo "Creating MSI packages for Aspia Client"
"%WIX%\bin\candle" -out "%TMP_DIR%\\" -ext WixUtilExtension -ext WixUIExtension client.wxs
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-de-de.msi" -cultures:de-de -ext WixUtilExtension -ext WixUIExtension -loc translations\client.de-de.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-en-us.msi" -cultures:en-us -ext WixUtilExtension -ext WixUIExtension -loc translations\client.en-us.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-it-it.msi" -cultures:it-it -ext WixUtilExtension -ext WixUIExtension -loc translations\client.it-it.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-nl-nl.msi" -cultures:nl-nl -ext WixUtilExtension -ext WixUIExtension -loc translations\client.nl-nl.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-pt-br.msi" -cultures:pt-br -ext WixUtilExtension -ext WixUIExtension -loc translations\client.pt-br.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-ru-ru.msi" -cultures:ru-ru -ext WixUtilExtension -ext WixUIExtension -loc translations\client.ru-ru.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-uk-ua.msi" -cultures:uk-ua -ext WixUtilExtension -ext WixUIExtension -loc translations\client.uk-ua.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-zh-cn.msi" -cultures:zh-cn -ext WixUtilExtension -ext WixUIExtension -loc translations\client.zh-cn.wxl "%TMP_DIR%\client.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-client-zh-tw.msi" -cultures:zh-tw -ext WixUtilExtension -ext WixUIExtension -loc translations\client.zh-tw.wxl "%TMP_DIR%\client.wixobj"
...
copy %TMP_DIR%\aspia-client-en-us.msi %ASPIA_BIN_DIR%\aspia-client-%ASPIA_VERSION%-%ASPIA_ARCH%.msi

echo "##################################################"
echo "Creating MSI packages for Aspia Host"
"%WIX%\bin\candle" -out "%TMP_DIR%\\" -ext WixUtilExtension -ext WixUIExtension host.wxs
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-de-de.msi" -cultures:de-de -ext WixUtilExtension -ext WixUIExtension -loc translations\host.de-de.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-en-us.msi" -cultures:en-us -ext WixUtilExtension -ext WixUIExtension -loc translations\host.en-us.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-it-it.msi" -cultures:it-it -ext WixUtilExtension -ext WixUIExtension -loc translations\host.it-it.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-nl-nl.msi" -cultures:nl-nl -ext WixUtilExtension -ext WixUIExtension -loc translations\host.nl-nl.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-pt-br.msi" -cultures:pt-br -ext WixUtilExtension -ext WixUIExtension -loc translations\host.pt-br.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-ru-ru.msi" -cultures:ru-ru -ext WixUtilExtension -ext WixUIExtension -loc translations\host.ru-ru.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-uk-ua.msi" -cultures:uk-ua -ext WixUtilExtension -ext WixUIExtension -loc translations\host.uk-ua.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-zh-cn.msi" -cultures:zh-cn -ext WixUtilExtension -ext WixUIExtension -loc translations\host.zh-cn.wxl "%TMP_DIR%\host.wixobj"
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-host-zh-tw.msi" -cultures:zh-tw -ext WixUtilExtension -ext WixUIExtension -loc translations\host.zh-tw.wxl "%TMP_DIR%\host.wixobj"
...
copy %TMP_DIR%\aspia-host-en-us.msi %ASPIA_BIN_DIR%\aspia-host-%ASPIA_VERSION%-%ASPIA_ARCH%.msi

echo "##################################################"
echo "Creating MSI packages for Aspia Router"
"%WIX%\bin\candle" -out "%TMP_DIR%\\" -ext WixUtilExtension -ext WixUIExtension router.wxs
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-router.msi" -cultures:en-us -ext WixUtilExtension -ext WixUIExtension -loc translations\router.en-us.wxl "%TMP_DIR%\router.wixobj"
copy %TMP_DIR%\aspia-router.msi %ASPIA_BIN_DIR%\aspia-router-%ASPIA_VERSION%-%ASPIA_ARCH%.msi

echo "##################################################"
echo "Creating MSI packages for Aspia Relay"
"%WIX%\bin\candle" -out "%TMP_DIR%\\" -ext WixUtilExtension -ext WixUIExtension relay.wxs
"%WIX%\bin\light" -out "%TMP_DIR%\aspia-relay.msi" -cultures:en-us -ext WixUtilExtension -ext WixUIExtension -loc translations\relay.en-us.wxl "%TMP_DIR%\relay.wixobj"
copy %TMP_DIR%\aspia-relay.msi %ASPIA_BIN_DIR%\aspia-relay-%ASPIA_VERSION%-%ASPIA_ARCH%.msi
