...
enum DesktopConfig_Flags {
  ...
  DesktopConfig_Flags_ENABLE_DESKTOP_EFFECTS = 1,
  DesktopConfig_Flags_ENABLE_CURSOR_SHAPE = 2,
  DesktopConfig_Flags_ENABLE_CLIPBOARD = 4,
...
const DesktopConfig_Flags DesktopConfig_Flags_Flags_MAX = DesktopConfig_Flags_ENABLE_CLIPBOARD;
...
class DesktopConfig : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:aspia.proto.DesktopConfig) */ {
 public:
  ...
  static const Flags ENABLE_DESKTOP_EFFECTS =
    DesktopConfig_Flags_ENABLE_DESKTOP_EFFECTS;
...
// .aspia.proto.VideoEncoding encoding = 2;
inline void DesktopConfig::clear_encoding() {
  encoding_ = 0;
}
inline ::aspia::proto::VideoEncoding DesktopConfig::encoding() const {
  // @@protoc_insertion_point(field_get:aspia.proto.DesktopConfig.encoding)
  return static_cast< ::aspia::proto::VideoEncoding >(encoding_);
}
inline void DesktopConfig::set_encoding(::aspia::proto::VideoEncoding value) {
